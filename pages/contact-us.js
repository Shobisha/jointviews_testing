            ...
            <div className="container">
                <div className='row'>
                    ...
                    <li className='breadcrumbulli'>
                          <a href="https://www.jointviews.com" rel="nofollow" className='alink'>Home</a>
                          </li>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xs-12 col-sm-5">
                            <h2 className="brdrnone .htwoget"><strong className='stronggethwo'>Get In</strong> Touch</h2>
                            <img className="contact-ogo" src="/images/contact_logo.png" alt="Contact Logo" />
                            <div className="row">
                                <div className="col-md-12 col-xs-12">
                                    <div className="textborderbtm">
                                        <strong className='strongget'>Address:</strong>
                                        <div className="trxt">
                                            Jointviews,Edsys Towers, Near ICICI Bank ATM, Kamaleswaram, Trivandrum, Kerala, PIN – 695009
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="default-form">
                                    <form>
                                        <div className="form-group formgroupget">
                                            <input type="text" className="form-control formcontrolget" placeholder="Name" />
                                        </div>
                                        <div className="form-group formgroupget">
                                            <input type="email" className="form-control formcontrolget" placeholder="E-mail" />
                                        </div>
                                        <div className="form-group formgroupget">
                                            <input type="text" className="form-control formcontrolget" placeholder="Subject" />
                                        </div>
                                        <div className="form-group formgroupget">
                                            <textarea className="form-control inputtextarea" rows="6" placeholder="Message"></textarea>
                                        </div>
                                        <div className="form-group formgroupget" style={{ position: "relative" }}>
                                            <input type="submit" value="Send" className="subbtn text-center subbtntxt" />
                                            <div className="loaderget" style={{ padding: "70px" }}></div>
                                        </div>
